...
def render_finding_detail(finding: Optional[Dict[str, Any]]) -> None:
    ...
    st.markdown(
        ...
        <div class="rf20-pagehead" style="padding-bottom:0.9rem; margin-bottom:1rem;">
            <div class="rf20-eyebrow">Hallazgo seleccionado</div>
            <div class="rf20-title" style="font-size:1.35rem; margin-bottom:0.12rem;">{finding.get('title') or 'Hallazgo'}</div>
            <div class="rf20-subtitle">{finding.get("finding_id") or finding.get("test_id") or "-"}</div>
            ...
            <div class="rf20-summary-strip">
                ...
                <div class="rf20-summary-item"><div class="rf20-summary-label">Registros afectados</div><div class="rf20-summary-value">{finding.get("finding_count") or 0}</div></div>
                <div class="rf20-summary-item"><div class="rf20-summary-label">Entity key</div><div class="rf20-summary-value">{finding.get("sample_entity_key") or "-"}</div></div>
            </div>
        </div>
        """,
